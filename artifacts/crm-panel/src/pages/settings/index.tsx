      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <div className="relative pl-4">
            ...
            <h1 className="text-2xl font-bold tracking-tight">Системные</h1>
            <p className="text-[13px] text-muted-foreground mt-0.5">Аудит-лог, активность пользователей и DDEX/DSP интеграции.</p>
          </div>
        </div>
          ...
          <TabsContent value="ddex" className="mt-4 space-y-4">
            <Card className="card-surface no-lift border-border/60">
              <CardHeader>
                ...
                <CardDescription>Параметры лейбла, используемые DDEX worker'ом для всех XML-доставок (read-only — управляется через worker config).</CardDescription>
              </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    ...
                    <Button variant="outline" size="icon" aria-label="Копировать DPID"
                      onClick={() => { navigator.clipboard?.writeText("PA-DPIDA-2024053004-T"); toast({ title: "Скопировано" }); }}>
            ...
            <Card className="card-surface no-lift border-border/60">
              <CardHeader className="flex flex-row items-center justify-between gap-4 flex-wrap">
                <div>
                  ...
                  <CardDescription>Человекочитаемые события платформы (для виджета «Recent activity» на дашборде).</CardDescription>
                </div>
                <div className="flex gap-2">
                  <Input
                    value={actFilter}

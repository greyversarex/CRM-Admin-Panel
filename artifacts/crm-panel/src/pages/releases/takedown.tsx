      ...
      <div className="flex flex-col gap-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            {/* Broma16 на прямой вопрос ответила, что метода снятия в партнёрском
                API нет и функционал предполагается использовать через их кабинет.
                Раз заявка сама туда не уходит — так и пишем, иначе оператор
                считает, что дело сделано, и релиз остаётся на площадках. */}
            <p className="text-amber-300/90 text-xs mt-2 max-w-2xl">
              Заявка регистрируется у нас, но в Broma16 автоматически не уходит: метода снятия
              в их API нет. После создания заявки снимите релиз в кабинете Broma16 вручную.
            </p>
          </div>

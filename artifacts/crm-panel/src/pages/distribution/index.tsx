...
import { BromaDraftsTab } from "@/pages/distribution/broma-drafts-tab";
import { BromaReconcileTab } from "@/pages/distribution/broma-reconcile-tab";
      ...
      <div className="flex flex-col gap-6">
        ...
        <Tabs value={tab} onValueChange={setTab}>
          <TabsList className="flex flex-wrap h-auto">
            ...
            <TabsTrigger value="broma-reconcile" data-testid="tab-broma-reconcile"><RefreshCw className="w-4 h-4 mr-2" />Сверка с Бромой</TabsTrigger>
            <TabsTrigger value="broma-drafts" data-testid="tab-broma-drafts"><FileCode2 className="w-4 h-4 mr-2" />Черновики Бромы</TabsTrigger>
          ...
          <TabsContent value="broma-reconcile" className="space-y-4">
            <BromaReconcileTab />
          </TabsContent>
          <TabsContent value="broma-drafts" className="space-y-4">
            <BromaDraftsTab />
          </TabsContent>

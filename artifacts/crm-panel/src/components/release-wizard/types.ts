...
export const SUBGENRES: Record<string, string[]> = {
  ...
  "Dance": ["Dance Pop", "Eurodance", "Club Dance", "Electronic Dance", "Progressive Dance", "Vocal Dance", "Latin Dance", "Disco Dance", "Freestyle", "Hi-NRG", "Italo Dance", "Big Room", "Tropical Dance", "Electro Dance", "Urban Dance", "Dancehall", "Deep Dance", "Afro Dance", "Pop Dance", "Remix Dance", "Dance EDM", "EDM", "House Dance", "Tech Dance", "Country"],
  ...
  "Drum & Bass": ["Liquid DnB", "Neurofunk", "Jungle", "Jump Up", "Darkstep", "Drumstep", "Atmospheric DnB", "Classical"],
  "Dubstep": ["Brostep", "Melodic Dubstep", "Chill Dubstep", "Heavy Dubstep", "Future Dubstep", "Experimental Dubstep", "Opera"],
  "Lo-Fi": ["Lo-Fi Hip-Hop", "Chillhop", "Study Beats", "Jazzhop", "Ambient Lo-Fi", "Lo-Fi Chill", "Instrumental"],
  "Indie": ["Indie Pop", "Indie Rock", "Indie Folk", "Indie Dance", "Indie Electronic", "Indie Alternative", "Bedroom Pop", "Lo-Fi Indie", "New Age"],
  "Alternative": ["Alternative Rock", "Alternative Pop", "Alternative Hip-Hop", "Alternative Metal", "Indie Alternative", "Experimental Alternative", "Post Alternative", "Ambient"],
  "Jazz": ["Smooth Jazz", "Vocal Jazz", "Bebop", "Swing", "Big Band", "Acid Jazz", "Latin Jazz", "Jazz Fusion", "Contemporary Jazz", "Free Jazz", "Easy Listening"],
  "Blues": ["Blues Rock", "Delta Blues", "Chicago Blues", "Acoustic Blues", "Modern Blues", "Electric Blues", "Funk"],
  "Country Pop": ["Country Rock", "Traditional Country", "Bluegrass", "Modern Country", "Folk Country", "Americana Country"],
  "Folk Rock": ["Indie Folk", "Traditional Folk", "Acoustic Folk", "Celtic Folk", "Modern Folk", "World Folk"],
  "Baroque": ["Romantic Classical", "Modern Classical", "Orchestral", "Chamber Music", "Piano Classical", "Symphony", "Minimal Classical"],
  "Classical Opera": ["Modern Opera", "Crossover Opera", "Vocal Opera", "Symphonic Opera"],
  "Instrumental Pop": ["Instrumental Rock", "Piano Instrumental", "Cinematic Instrumental", "Acoustic Instrumental", "Ambient Instrumental"],
  "Meditation Music": ["Healing Music", "Spiritual New Age", "Nature Sounds", "Relaxation Music", "Yoga Music"],
  "Dark Ambient": ["Space Ambient", "Drone Ambient", "Cinematic Ambient", "Chill Ambient", "Minimal Ambient"],
  "Soft Pop": ["Lounge Music", "Background Music", "Romantic Easy Listening", "Acoustic Easy Listening"],
  "Funk Rock": ["Jazz Funk", "Disco Funk", "Pop Funk", "Afro Funk", "Electro Funk"],
  "Disco": [],
  "Punk": [],
  "Metal": [],
  "Reggae": [],
  ...
  "Gospel": [],
  "Religious": [],
  "Classic Disco": ["Nu Disco", "Disco Pop", "Funk Disco", "Italo Disco"],
  "Punk Rock": ["Pop Punk", "Hardcore Punk", "Post Punk", "Ska Punk", "Indie Punk"],
  "Heavy Metal": ["Death Metal", "Black Metal", "Power Metal", "Progressive Metal", "Nu Metal", "Alternative Metal"],
  "Roots Reggae": ["Dub Reggae", "Dancehall", "Reggae Fusion", "Lovers Rock"],
  "Traditional Ska": ["Ska Punk", "2 Tone Ska", "Reggae Ska Fusion"],
  "Latin Pop": ["Latin Urban", "Latin Trap", "Latin Rock", "Salsa", "Bachata", "Reggaeton", "Latin Jazz", "Merengue"],
  "Afro Pop": ["Afro House", "Afro Fusion", "Afro Dance", "Afro Trap", "Afro Soul", "Afro Hip-Hop"],
  "Contemporary Gospel": ["Traditional Gospel", "Gospel Choir", "Urban Gospel", "Christian Gospel"],
  "Spiritual Music": ["Devotional Music", "Islamic Nasheed", "Mantra Music", "Sacred Music"],
  "Christian": [],
  "Traditional": [],
  "World Music": [],
  "Soundtrack": [],
  ...
  "Vocal": [],
  "Singer/Songwriter": [],
  "Christian Pop": ["Christian Rock", "Christian Rap", "Worship Music", "Praise Music"],
  "Ethnic Traditional": ["Regional Traditional", "Folk Traditional", "Ceremonial Music", "Heritage Music"],
  "World Fusion": ["Ethnic Fusion", "Global Beats", "Traditional World", "Modern World Fusion"],
  "Film Score": ["TV Soundtrack", "Trailer Music", "Game Soundtrack", "Cinematic Score", "Background Score"],
  "Anime OST": ["Anime Pop", "Anime Rock", "Anime Instrumental", "J-Anime Fusion"],
  "Bollywood Pop": ["Bollywood Soundtrack", "Bollywood Dance", "Bollywood Romantic", "Bollywood Classical Fusion"],
  "Avant-Garde": ["Noise Music", "Experimental Electronic", "Experimental Rock", "Sound Art", "Minimal Experimental"],
  "Male Vocal": ["Female Vocal", "Duet", "Choir", "A Cappella", "Vocal Pop", "Vocal Jazz", "Vocal House", "Opera Vocal"],
  "Acoustic Singer/Songwriter": ["Indie Singer/Songwriter", "Folk Singer/Songwriter", "Pop Singer/Songwriter", "Emotional Ballads", "Storytelling Songs"],
  "Cinematic": ["Epic Cinematic", "Trailer Cinematic", "Emotional Cinematic", "Dark Cinematic", "Orchestral Cinematic", "Hybrid Cinematic", "Action Cinematic", "Ambient Cinematic"],
...
export const SUBGENRE_OPTIONS: Array<{ value: string; label: string }> = [
  ...
  { value: "Acoustic Pop", label: "Acoustic Pop" }, { value: "Action Cinematic", label: "Action Cinematic" }, { value: "Afghan Classical", label: "Afghan Classical" }, { value: "Afghan Dance", label: "Afghan Dance" },
  ...
  { value: "Ambient", label: "Ambient" }, { value: "Ambient Cinematic", label: "Ambient Cinematic" }, { value: "Ambient Instrumental", label: "Ambient Instrumental" }, { value: "Ambient Lo-Fi", label: "Ambient Lo-Fi" },
  { value: "Americana Country", label: "Americana Country" }, { value: "Anatolian Folk", label: "Anatolian Folk" }, { value: "Anatolian Rock", label: "Anatolian Rock" }, { value: "Anime Instrumental", label: "Anime Instrumental" },
  { value: "Anime Music", label: "Anime Music" }, { value: "Anime Pop", label: "Anime Pop" }, { value: "Anime Rock", label: "Anime Rock" }, { value: "Arabic Classical", label: "Arabic Classical" },
  { value: "Arabic Dance", label: "Arabic Dance" }, { value: "Arabic Electronic", label: "Arabic Electronic" }, { value: "Arabic Folk", label: "Arabic Folk" }, { value: "Arabic Hip-Hop", label: "Arabic Hip-Hop" },
  { value: "Arabic Pop", label: "Arabic Pop" }, { value: "Arabic R&B", label: "Arabic R&B" }, { value: "Arabic Rap", label: "Arabic Rap" }, { value: "Arabic Rock", label: "Arabic Rock" },
  { value: "Arabic Traditional", label: "Arabic Traditional" }, { value: "Arena Rock", label: "Arena Rock" }, { value: "Art Pop", label: "Art Pop" }, { value: "Atmospheric DnB", label: "Atmospheric DnB" },
  ...
  { value: "Bass House", label: "Bass House" }, { value: "Bebop", label: "Bebop" }, { value: "Bedouin", label: "Bedouin" }, { value: "Bedroom Pop", label: "Bedroom Pop" },
  { value: "Bhangra", label: "Bhangra" }, { value: "Big Band", label: "Big Band" }, { value: "Big Room", label: "Big Room" }, { value: "Biography Audiobook", label: "Biography Audiobook" },
  { value: "Black Metal", label: "Black Metal" }, { value: "Bluegrass", label: "Bluegrass" }, { value: "Blues Rock", label: "Blues Rock" }, { value: "Bollywood", label: "Bollywood" },
  { value: "Bollywood Classical Fusion", label: "Bollywood Classical Fusion" }, { value: "Bollywood Dance", label: "Bollywood Dance" }, { value: "Bollywood Romantic", label: "Bollywood Romantic" }, { value: "Bollywood Soundtrack", label: "Bollywood Soundtrack" },
  { value: "Boom Bap", label: "Boom Bap" }, { value: "Bossa Nova", label: "Bossa Nova" }, { value: "Brazilian Funk", label: "Brazilian Funk" }, { value: "Brazilian Hip-Hop", label: "Brazilian Hip-Hop" },
  { value: "Brazilian Pop", label: "Brazilian Pop" }, { value: "Breakbeat", label: "Breakbeat" }, { value: "Brostep", label: "Brostep" }, { value: "C-Pop", label: "C-Pop" },
  { value: "Cantopop", label: "Cantopop" }, { value: "Cartoon Songs", label: "Cartoon Songs" }, { value: "Celtic Folk", label: "Celtic Folk" }, { value: "Central Asian Chill", label: "Central Asian Chill" },
  { value: "Central Asian Classical", label: "Central Asian Classical" }, { value: "Central Asian Dance", label: "Central Asian Dance" }, { value: "Central Asian Electronic", label: "Central Asian Electronic" }, { value: "Central Asian Experimental", label: "Central Asian Experimental" },
  { value: "Central Asian Folk", label: "Central Asian Folk" }, { value: "Central Asian Fusion", label: "Central Asian Fusion" }, { value: "Central Asian Hip-Hop", label: "Central Asian Hip-Hop" }, { value: "Central Asian House", label: "Central Asian House" },
  { value: "Central Asian Instrumental", label: "Central Asian Instrumental" }, { value: "Central Asian Jazz", label: "Central Asian Jazz" }, { value: "Central Asian Modern", label: "Central Asian Modern" }, { value: "Central Asian Pop", label: "Central Asian Pop" },
  { value: "Central Asian Rap", label: "Central Asian Rap" }, { value: "Central Asian Rock", label: "Central Asian Rock" }, { value: "Central Asian Spiritual", label: "Central Asian Spiritual" }, { value: "Central Asian Traditional", label: "Central Asian Traditional" },
  { value: "Central Asian Wedding Music", label: "Central Asian Wedding Music" }, { value: "Ceremonial Music", label: "Ceremonial Music" }, { value: "Chamber Music", label: "Chamber Music" }, { value: "Chicago Blues", label: "Chicago Blues" },
  { value: "Chill Ambient", label: "Chill Ambient" }, { value: "Chill Dubstep", label: "Chill Dubstep" }, { value: "Chill Electronic", label: "Chill Electronic" }, { value: "Chillhop", label: "Chillhop" },
  { value: "Chinese Classical", label: "Chinese Classical" }, { value: "Chinese EDM", label: "Chinese EDM" }, { value: "Chinese Folk", label: "Chinese Folk" }, { value: "Chinese Hip-Hop", label: "Chinese Hip-Hop" },
  { value: "Chinese Indie", label: "Chinese Indie" }, { value: "Chinese Rock", label: "Chinese Rock" }, { value: "Chinese Traditional", label: "Chinese Traditional" }, { value: "Choir", label: "Choir" },
  { value: "Christian Gospel", label: "Christian Gospel" }, { value: "Christian Rap", label: "Christian Rap" }, { value: "Christian Rock", label: "Christian Rock" }, { value: "Christmas Music", label: "Christmas Music" },
  { value: "Cinematic Ambient", label: "Cinematic Ambient" }, { value: "Cinematic Instrumental", label: "Cinematic Instrumental" }, { value: "Cinematic Score", label: "Cinematic Score" }, { value: "City Pop", label: "City Pop" },
  { value: "Classic Karaoke", label: "Classic Karaoke" }, { value: "Classic Rock", label: "Classic Rock" }, { value: "Classical", label: "Classical" }, { value: "Club Dance", label: "Club Dance" },
  { value: "Club House", label: "Club House" }, { value: "Comedy Story", label: "Comedy Story" }, { value: "Conscious Rap", label: "Conscious Rap" }, { value: "Contemporary Jazz", label: "Contemporary Jazz" },
  { value: "Contemporary R&B", label: "Contemporary R&B" }, { value: "Country", label: "Country" }, { value: "Country Rock", label: "Country Rock" }, { value: "Crossover Opera", label: "Crossover Opera" },
  { value: "Dance EDM", label: "Dance EDM" }, { value: "Dance Pop", label: "Dance Pop" }, { value: "Dancehall", label: "Dancehall" }, { value: "Dari Music", label: "Dari Music" },
  { value: "Dark Cinematic", label: "Dark Cinematic" }, { value: "Darkstep", label: "Darkstep" }, { value: "Death Metal", label: "Death Metal" }, { value: "Deep Dance", label: "Deep Dance" },
  { value: "Deep House", label: "Deep House" }, { value: "Delta Blues", label: "Delta Blues" }, { value: "Detroit Techno", label: "Detroit Techno" }, { value: "Devotional", label: "Devotional" },
  { value: "Devotional Music", label: "Devotional Music" }, { value: "Digital Pop", label: "Digital Pop" }, { value: "Disco Dance", label: "Disco Dance" }, { value: "Disco Funk", label: "Disco Funk" },
  { value: "Disco Pop", label: "Disco Pop" }, { value: "Dream Pop", label: "Dream Pop" }, { value: "Drill", label: "Drill" }, { value: "Drone Ambient", label: "Drone Ambient" },
  { value: "Drum & Bass", label: "Drum & Bass" }, { value: "Drumstep", label: "Drumstep" }, { value: "Dub Reggae", label: "Dub Reggae" }, { value: "Dubstep", label: "Dubstep" },
  { value: "Duet", label: "Duet" }, { value: "East Coast Rap", label: "East Coast Rap" }, { value: "Easter Music", label: "Easter Music" }, { value: "Easy Listening", label: "Easy Listening" },
  ...
  { value: "Emotional Cinematic", label: "Emotional Cinematic" }, { value: "Enka", label: "Enka" }, { value: "Epic Cinematic", label: "Epic Cinematic" }, { value: "Ethnic Fusion", label: "Ethnic Fusion" },
  { value: "Euro House", label: "Euro House" }, { value: "Eurodance", label: "Eurodance" }, { value: "Europop", label: "Europop" }, { value: "Experimental Alternative", label: "Experimental Alternative" },
  { value: "Experimental Dubstep", label: "Experimental Dubstep" }, { value: "Experimental Electronic", label: "Experimental Electronic" }, { value: "Experimental Rock", label: "Experimental Rock" }, { value: "Falak", label: "Falak" },
  { value: "Female Vocal", label: "Female Vocal" }, { value: "Fiction Audiobook", label: "Fiction Audiobook" }, { value: "Filmi", label: "Filmi" }, { value: "Folk", label: "Folk" },
  { value: "Folk Country", label: "Folk Country" }, { value: "Folk Rock", label: "Folk Rock" }, { value: "Folk Singer/Songwriter", label: "Folk Singer/Songwriter" }, { value: "Folk Traditional", label: "Folk Traditional" },
  { value: "Forró", label: "Forró" }, { value: "Free Jazz", label: "Free Jazz" }, { value: "Freestyle", label: "Freestyle" }, { value: "French House", label: "French House" },
  { value: "French Pop", label: "French Pop" }, { value: "Funk", label: "Funk" }, { value: "Funk Carioca", label: "Funk Carioca" }, { value: "Funk Disco", label: "Funk Disco" },
  ...
  { value: "Healing Music", label: "Healing Music" }, { value: "Heavy Dubstep", label: "Heavy Dubstep" }, { value: "Heritage Music", label: "Heritage Music" }, { value: "Hi-NRG", label: "Hi-NRG" },
  { value: "Highlife", label: "Highlife" }, { value: "Hip-Hop", label: "Hip-Hop" }, { value: "House", label: "House" }, { value: "House Dance", label: "House Dance" },
  { value: "Hybrid Cinematic", label: "Hybrid Cinematic" }, { value: "IDM", label: "IDM" }, { value: "Improvisation", label: "Improvisation" }, { value: "Indian Classical", label: "Indian Classical" },
  ...
  { value: "Indie Rock", label: "Indie Rock" }, { value: "Indie Singer/Songwriter", label: "Indie Singer/Songwriter" }, { value: "Industrial Techno", label: "Industrial Techno" }, { value: "Instrumental", label: "Instrumental" },
  { value: "Instrumental Karaoke", label: "Instrumental Karaoke" }, { value: "Instrumental Rock", label: "Instrumental Rock" }, { value: "Islamic Nasheed", label: "Islamic Nasheed" }, { value: "Italo Dance", label: "Italo Dance" },
  ...
  { value: "Latin Dance", label: "Latin Dance" }, { value: "Latin Jazz", label: "Latin Jazz" }, { value: "Latin Rap", label: "Latin Rap" }, { value: "Latin Rock", label: "Latin Rock" },
  { value: "Latin Trap", label: "Latin Trap" }, { value: "Latin Urban", label: "Latin Urban" }, { value: "Levantine", label: "Levantine" }, { value: "Liquid DnB", label: "Liquid DnB" },
  { value: "Lo-Fi Chill", label: "Lo-Fi Chill" }, { value: "Lo-Fi Hip-Hop", label: "Lo-Fi Hip-Hop" }, { value: "Lo-Fi Indie", label: "Lo-Fi Indie" }, { value: "Lounge Music", label: "Lounge Music" },
  { value: "Lovers Rock", label: "Lovers Rock" }, { value: "Lullabies", label: "Lullabies" }, { value: "Maghrebi", label: "Maghrebi" }, { value: "Mahraganat", label: "Mahraganat" },
  { value: "Mandopop", label: "Mandopop" }, { value: "Mantra Music", label: "Mantra Music" }, { value: "Melodic Dubstep", label: "Melodic Dubstep" }, { value: "Melodic Techno", label: "Melodic Techno" },
  { value: "Merengue", label: "Merengue" }, { value: "Minimal Ambient", label: "Minimal Ambient" }, { value: "Minimal Classical", label: "Minimal Classical" }, { value: "Minimal Experimental", label: "Minimal Experimental" },
  { value: "Minimal Techno", label: "Minimal Techno" }, { value: "Modern Blues", label: "Modern Blues" }, { value: "Modern Classical", label: "Modern Classical" }, { value: "Modern Country", label: "Modern Country" },
  { value: "Modern Folk", label: "Modern Folk" }, { value: "Modern Opera", label: "Modern Opera" }, { value: "Modern World Fusion", label: "Modern World Fusion" }, { value: "Motivational Speech", label: "Motivational Speech" },
  { value: "Motown", label: "Motown" }, { value: "MPB (Música Popular Brasileira)", label: "MPB (Música Popular Brasileira)" }, { value: "Mumble Rap", label: "Mumble Rap" }, { value: "National Holiday Music", label: "National Holiday Music" },
  { value: "Nature Sounds", label: "Nature Sounds" }, { value: "Neo Soul", label: "Neo Soul" }, { value: "Neurofunk", label: "Neurofunk" }, { value: "New Age", label: "New Age" },
  { value: "New Year Music", label: "New Year Music" }, { value: "Noise Music", label: "Noise Music" }, { value: "Non-Fiction Audiobook", label: "Non-Fiction Audiobook" }, { value: "Nu Disco", label: "Nu Disco" },
  { value: "Nu Metal", label: "Nu Metal" }, { value: "Nursery Rhymes", label: "Nursery Rhymes" }, { value: "Opera", label: "Opera" }, { value: "Opera Vocal", label: "Opera Vocal" },
  { value: "Orchestral", label: "Orchestral" }, { value: "Orchestral Cinematic", label: "Orchestral Cinematic" }, { value: "Pagode", label: "Pagode" }, { value: "Pamiri", label: "Pamiri" },
  ...
  { value: "Punjabi Romantic", label: "Punjabi Romantic" }, { value: "Rai", label: "Rai" }, { value: "Ramadan Music", label: "Ramadan Music" }, { value: "Rap", label: "Rap" },
  { value: "Rap Rock", label: "Rap Rock" }, { value: "Reggae Fusion", label: "Reggae Fusion" }, { value: "Reggae Ska Fusion", label: "Reggae Ska Fusion" }, { value: "Reggaeton", label: "Reggaeton" },
  { value: "Regional Karaoke", label: "Regional Karaoke" }, { value: "Regional Traditional", label: "Regional Traditional" }, { value: "Relaxation Music", label: "Relaxation Music" }, { value: "Remix Dance", label: "Remix Dance" },
  { value: "Rhythmic Soul", label: "Rhythmic Soul" }, { value: "Rock Karaoke", label: "Rock Karaoke" }, { value: "Romantic Classical", label: "Romantic Classical" }, { value: "Romantic Easy Listening", label: "Romantic Easy Listening" },
  { value: "Russian Pop", label: "Russian Pop" }, { value: "Russian Rap", label: "Russian Rap" }, { value: "Sacred Music", label: "Sacred Music" }, { value: "Salsa", label: "Salsa" },
  { value: "Samba", label: "Samba" }, { value: "Satire", label: "Satire" }, { value: "Self-Help Audiobook", label: "Self-Help Audiobook" }, { value: "Sertanejo", label: "Sertanejo" },
  { value: "Shashmaqom", label: "Shashmaqom" }, { value: "Ska Punk", label: "Ska Punk" }, { value: "Sketch Comedy", label: "Sketch Comedy" }, { value: "Slow Rock", label: "Slow Rock" },
  { value: "Smooth Jazz", label: "Smooth Jazz" }, { value: "Soft Rock", label: "Soft Rock" }, { value: "Soukous", label: "Soukous" }, { value: "Soul", label: "Soul" },
  { value: "Sound Art", label: "Sound Art" }, { value: "Southern Rock", label: "Southern Rock" }, { value: "Space Ambient", label: "Space Ambient" }, { value: "Space Rock", label: "Space Rock" },
  { value: "Speech", label: "Speech" }, { value: "Spiritual New Age", label: "Spiritual New Age" }, { value: "Stand-up Comedy", label: "Stand-up Comedy" }, { value: "Story Audiobook", label: "Story Audiobook" },
  ...
  { value: "Traditional Country", label: "Traditional Country" }, { value: "Traditional Folk", label: "Traditional Folk" }, { value: "Traditional Gospel", label: "Traditional Gospel" }, { value: "Traditional World", label: "Traditional World" },
  { value: "Trailer Cinematic", label: "Trailer Cinematic" }, { value: "Trailer Music", label: "Trailer Music" }, { value: "Trance", label: "Trance" }, { value: "Trap", label: "Trap" },
  ...
  { value: "Worship Music", label: "Worship Music" }, { value: "Yoga Music", label: "Yoga Music" },
];

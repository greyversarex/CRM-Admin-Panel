  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          "flex items-center justify-center h-9 border-t border-[hsl(var(--sidebar-border))] bg-transparent hover:bg-white/[0.04] transition-colors cursor-pointer text-white/30 hover:text-white/70",

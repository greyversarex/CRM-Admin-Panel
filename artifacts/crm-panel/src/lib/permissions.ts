...
export const ROUTE_ROLES: Record<string, Role[]> = {
  ...
  "/delivery":       ["admin", "manager", "label", "artist"],
  "/releases":       ["admin", "manager", "label", "artist"],
  "/releases/bulk":     ["admin", "manager"],
  "/releases/transfer": ["admin", "manager", "label", "artist"],
  "/releases/transfer/new": ["admin", "manager", "label", "artist"],
  "/releases/:id/availability": ["admin", "manager", "label", "artist"],
  "/releases/:id/splitshare": ["admin", "manager", "label", "artist"],
  "/releases/calendar":  ["admin", "manager", "label"],
  "/releases/takedown":  ["admin", "manager", "label", "artist"],
  ...
  "/settings":       ["admin", "manager", "label", "artist"],
  ...
  "/catalog/codes":      ["admin", "manager", "label"],
  "/automation":         ["admin", "manager"],
  "/communications":     ["admin", "manager"],
  // Marketing — лейбл и артист
  "/marketing":           ["admin", "manager", "label", "artist"],
